...
(function (factory) {
  ...
  Chart.defaults.global.colors = ['#97BBCD', // blue
  '#DCDCDC', // light grey
  '#F7464A', // red
  '#46BFBD', // green
  '#FDB45C', // yellow
  ...
  var useExcanvas = _typeof(window.G_vmlCanvasManager) === 'object' && window.G_vmlCanvasManager !== null && typeof window.G_vmlCanvasManager.initElement === 'function';

  if (useExcanvas) Chart.defaults.global.animation = false;

  return angular.module('chart.js', []).provider('ChartJs', ChartJsProvider).factory('ChartJsFactory', ['ChartJs', '$timeout', ChartJsFactory]).directive('chartBase', ['ChartJsFactory', function (ChartJsFactory) {
  ...
  function ChartJsFactory(ChartJs, $timeout) {
      ...
      return {
        ...
        link: function link(scope, elem /*, attrs */) {
          ...
          function watchData(newVal, oldVal) {
            ...
            if (scope.chart && canUpdateChart(newVal, oldVal)) return updateChart(newVal, scope);
    ...
    function canUpdateChart(newVal, oldVal) {
      if (newVal && oldVal && newVal.length && oldVal.length) {
        return Array.isArray(newVal[0]) ? newVal.length === oldVal.length && newVal.every(function (element, index) {
    ...
    function getEventHandler(scope, action, triggerOnlyOnChange) {
      ...
      return function (evt) {
        ...
        if (atEvents) {
          ...
          if (triggerOnlyOnChange === false || !angular.equals(lastState.points, points) && !angular.equals(lastState.point, point)) {
    ...
    function convertColor(color) {
      ...
      if ((typeof color === 'undefined' ? 'undefined' : _typeof(color)) === 'object' && color !== null) return color;
    ...
    function isEmpty(value) {
      return !value || Array.isArray(value) && !value.length || (typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object' && !Object.keys(value).length;
    }
